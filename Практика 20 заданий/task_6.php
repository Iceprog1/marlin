                        ...
                        <?php foreach ($users as $user): ?>
                            <div class="<?php echo $user['is_banned'] ? 'banned' : ''; ?>  rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                ...
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="https://twitter.com/@<?php echo $user['twitter'] ?>"
                                       class="text-info fs-sm" target="_blank">@<?php echo $user['twitter'] ?></a>
                                    -
                                    <a href="https://wrapbootstrap.com/user/<?php echo $user['mail'] ?>"
                                       class="text-info fs-sm" target="_blank"
                                       title="Contact <?php echo $user['name'] ?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
