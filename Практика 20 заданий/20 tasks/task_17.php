                            ...
                            <div class="panel-content">
                                <div class="panel-content">
                                    <div class="form-group">
                                        <form enctype="multipart/form-data" action="decisions/task17.php" method="POST">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <?php foreach ($result as $item):?>
                                            <div class="col-md-3 image">
                                                <img src="../20%20tasks/decisions/upload/<?php echo $item['image']?>">
                                                <a class="btn btn-danger" href="decisions/task17_delete.php?id=<?php echo $item['id']?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                            </div>
                                        <?php endforeach;?>
                                    </div>
                                </div>
